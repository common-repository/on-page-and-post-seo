...
Contributors: Rep U Press
Tags: SEO, Page, Post, Keyword Tool, Keyword Research, Keyword Density, Search Engine Optimization, Title, Content, Tools, Semantic, semantic search, DIY SEO Tools, SEO Tools, Local SEO
Requires at least: 3.0
Tested up to: 4.4.1
Stable tag: 1.0
License: GPLv2
License URI: http://www.gnu.org/licenses/gpl-2.0.html
The On-Page and Post SEO Wordpress Plugin gives you the DIY SEO Tools that will enable you to write better content and analyse it for SEO factors.
== Description ==
<strong>Welcome to the On-Page and Post SEO Plugin by RepUPress.com</strong>
The On-Page and Post SEO Wordpress Plugin gives your the <a title="The best DIY SEO Software and Tools." href="http://www.repupress.com/diy-seo/">DIY SEO Tools</a> that will enable you to write better content and analyse it for SEO factors to rank higher in Google, Yahoo and Bing and drive more traffic to your website.
<strong>We have created this Plugin to help you in optimizing your Posts and Pages with 2 powerful tools.  Both of these tools are located on the Edit Screen of any Page or Post.</strong>
...
== Screenshots ==
1. On-Page SEO Tool and Checker - This tool goes further than other popular SEO Plugins in analysing your post for key SEO metrics and factors the major search engines like Google look for.
2. Keyword Suggestion Tool - This tool enables you to find Semantically Related Keywords.  Google's algorithm is now able, through machine learning, to de-cypher users intent behind searches.
3. Keyword Suggestion tool Lists - Another really cool feature of this tool is the ability to quickly add these semantically related phrases as post tags.
== Changelog ==
= 1.0 =
